...
bool ObjectFinder::find_upright_coke_can(float surface_height, geometry_msgs::PoseStamped &object_pose) {
    ...
    bool found_object = true;
    double block_height = 0.018; //this height is specific to the coke_can model
    found_object = pclUtils_.find_plane_fit(0.4, 1, -0.5, 0.5, surface_height + 0.008, surface_height + 0.028, 0.001,
